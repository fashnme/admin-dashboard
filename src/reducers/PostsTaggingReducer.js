  ...
  export default (state = INITIAL_STATE, action) => {
      switch (action.type) {
        ...
        case FETCH_VISUALLY_SIMILAR_PRODUCTS:
            return { ...state, vsProducts: action.payload.products, loading: false, vsLoading: false };
        case FETCH_VISUALLY_SIMILAR_PRODUCTS_LOADING:
            return {...state, vsProducts:[], vsLoading: true}
